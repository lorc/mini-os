...
#endif
extern paddr_t physical_address_offset;	/* Add this to a virtual address to get the physical address (wraps at 4GB) */
#endif
...
#if defined(__aarch64__)
#define to_phys(x)  (((paddr_t)(x)-physical_address_offset) & 0xffffffffffffffff)
#define to_virt(x)  ((void *)(((x)+physical_address_offset) & 0xffffffffffffffff))
#else
